<html>
	...
	<body>
		<div>Bandcamp YAML - Takes a Bandcamp album URL and generates a YAML file, for use with the <a href="https://github.com/hsmusic">HS Music Wiki</a> repo. Note that only public albums and tracks can be accessed.</div>
